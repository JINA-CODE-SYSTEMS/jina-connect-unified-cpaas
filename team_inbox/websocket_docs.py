        ...
        200: openapi.Response(
            ...
            schema=openapi.Schema(
                ...
                properties={
                    ...
                    'supported_message_types': openapi.Schema(type=openapi.TYPE_ARRAY, items=openapi.Schema(type=openapi.TYPE_STRING)),
                    'example_messages': openapi.Schema(type=openapi.TYPE_OBJECT, description='Example WebSocket messages'),
                }
            )
        )
    }
