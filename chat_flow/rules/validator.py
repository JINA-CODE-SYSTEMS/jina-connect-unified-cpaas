...
from .base import FlowRule, RuleCategory, RuleSeverity, RuleViolation, ValidationResult
...
class FlowValidatorService:
    ...
    def validate(self, flow_data: Dict[str, Any], stop_on_first_error: bool = False) -> ValidationResult:
        """
    ...
    def validate_node(self, node: Dict[str, Any], flow_data: Optional[Dict[str, Any]] = None) -> ValidationResult:
        """
    ...
    def validate_edge(self, edge: Dict[str, Any], flow_data: Dict[str, Any]) -> ValidationResult:
        """
