...
class ChatFlow(BaseTenantModelForFilterUser):
    ...
    is_active = models.BooleanField(
        default=True,
        help_text="Whether this flow is active and can accept new sessions"
    )
...
class UserChatFlowSession(BaseModel):
    ...
    is_active = models.BooleanField(
        default=True,
        help_text="Whether this session is still active (user can continue)"
    )
    
    is_complete = models.BooleanField(
        default=False,
        help_text="Whether the user reached an end node (flow completed successfully)"
    )
    ...
    ended_at = models.DateTimeField(
        null=True,
        blank=True,
        help_text="When the session ended (completed or expired)"
    )
    ...
    context_data = models.JSONField(
        default=dict,
        blank=True,
        help_text="Additional context data collected during the flow"
    )
