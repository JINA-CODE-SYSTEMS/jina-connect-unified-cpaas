...
class MediaConverter:
    ...
    @classmethod
    def convert_image(
        cls, file, target_ext: Optional[str] = None, max_size_mb: Optional[float] = None, is_template: bool = True
    ...
    @classmethod
    def convert_video(
        cls, file, target_ext: str = ".mp4", max_size_mb: Optional[float] = None, is_template: bool = True
    ) -> Tuple[io.BytesIO, str, str]:
        """
    ...
    @classmethod
    def convert_audio(
        cls, file, target_ext: str = ".ogg", max_size_mb: Optional[float] = None
    ) -> Tuple[io.BytesIO, str, str]:
        """
