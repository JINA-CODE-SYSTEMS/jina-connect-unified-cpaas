...
their WhatsApp Business Account setup.
            ...
            201: openapi.Response(
                ...
                schema=openapi.Schema(
                    ...
                    properties={
                        ...
                        'gupshup_app_pk': openapi.Schema(type=openapi.TYPE_INTEGER, description='The TenantGupshupApp primary key'),
                        'esf_url': openapi.Schema(type=openapi.TYPE_STRING, description='The ESF URL for WhatsApp onboarding'),
                        'esf_url_expires_at': openapi.Schema(type=openapi.TYPE_STRING, format='date-time', description='ESF URL expiration timestamp'),
    ...
    def create_app(self, request, *args, **kwargs):
        ...
        try:
            result = ESFService.create_app_for_tenant(
                tenant_id=tenant.id
            )
    ...
    @action(detail=True, methods=["get", "post"], url_path="webhook-billing", url_name="webhook-billing", permission_classes=[AllowAny])
    ...
    @action(detail=True, methods=["get","post"], url_path="webhook-template", url_name="webhook-template", permission_classes=[AllowAny])
    ...
    @action(detail=True, methods=["get","post"], url_path="webhook-messages", url_name="webhook-messages" , permission_classes=[AllowAny])
    ...
    @action(detail=True, methods=["get","post"], url_path="webhook-misc", url_name="webhook-misc" , permission_classes=[AllowAny])
    ...
    def generate_esf_url(self, request, *args, **kwargs):
        ...
        try:
            ...
            result = service.generate_esf_url(
    ...
    @action(detail=False, methods=["post","get"], url_path="test-webhook", url_name="test-webhook", permission_classes=[AllowAny])
