...
class ESFService:
    ...
    def _get_partner_token(self) -> str:
        ...
        try:
            ...
            if not partner_credentials.email or not partner_credentials.password:
                raise ESFServiceError("Gupshup partner credentials not configured. Please set GUPSHUP_EMAIL and GUPSHUP_PASSWORD in settings.")
    ...
    def sync_waba_info(self) -> dict:
        ...
        try:
            ...
            waba_info, error = WABAInfo.update_from_api_response(
                self.wa_app, 
                response
            )
    ...
    def generate_for_tenant(
        ...
        try:
            ...
            service = cls(wa_app)
            return service.generate_esf_url(
                regenerate=regenerate,
                user=user,
                lang=lang
            )
    ...
    def create_app_for_tenant(
        ...
        try:
            ...
            app_data = {
                "name": app_name,
                "templateMessaging": template_messaging,
            ...
            try:
                service = cls(wa_app)
                esf_result = service.generate_esf_url(
                    regenerate=False,
                    user=None,
                    lang="en_US"
                )
