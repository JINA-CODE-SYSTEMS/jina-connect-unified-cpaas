...
class TenantRechargeWithCurrencyConversionTestCase(TestCase):
    ...
    def test_usd_tenant_recharge_with_inr_amount(self):
        ...
        print(f"🔍 DEBUG: Updating order status to SUCCESS...")
        ...
        print(f"🔍 DEBUG: Expected final balance: {Money((initial_balance.amount + expected_usd_equivalent.amount).quantize(Decimal('0.01')), 'USD')}")
        ...
        expected_balance = Money((initial_balance.amount + expected_usd_equivalent.amount).quantize(Decimal('0.01')), 'USD')
    ...
    def test_failed_recharge_no_balance_update(self):
        ...
        print(f"✅ Test 4 Passed - Failed Recharge:")
    ...
    def test_zero_balance_tenant_recharge(self):
        ...
        print(f"✅ Test 5 Passed - Zero Balance Recharge:")
    ...
    def test_negative_balance_tenant_recharge(self):
        ...
        print(f"✅ Test 6 Passed - Negative Balance Recharge:")
        print(f"   Initial Balance: {initial_balance}")
        print(f"   Recharge: {inr_amount}")
        print(f"   Converted Amount: {usd_equivalent}")
