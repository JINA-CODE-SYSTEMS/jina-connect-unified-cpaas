    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("system_transaction_id", models.CharField(blank=True, editable=False, max_length=100, null=True)),
                ...
                ("amount", djmoney.models.fields.MoneyField(decimal_places=4, default_currency="INR", max_digits=14)),
                (
                    "transaction_type",
                    models.CharField(
                        choices=[
