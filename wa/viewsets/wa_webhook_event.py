...
from wa.serializers import (WAWebhookEventListSerializer,
...
class WAWebhookEventViewSet(BaseTenantModelViewSet):
    ...
    @swagger_auto_schema(
        ...
        responses={
            200: openapi.Response(
                ...
                schema=WAWebhookEventListSerializer(many=True)
            ),
    ...
    @swagger_auto_schema(
        ...
        responses={
            200: openapi.Response(
                description="Webhook event details with full payload",
                schema=WAWebhookEventSerializer()
            ),
            401: openapi.Response(description="Authentication required"),
    ...
    def retry(self, request, pk=None):
        ...
        if event.is_processed:
            return Response(
                {'error': 'Event already processed successfully'},
