            ...
            "items": openapi.Schema(
                ...
                properties={
                    ...
                    "autofill_text": openapi.Schema(
                        type=openapi.TYPE_STRING,
                        description="Autofill text for ONE_TAP OTP buttons"
                    ),
    ...
    def to_internal_value(self, data):
        ...
        for i, button_data in enumerate(json_data):
            ...
            if button_type == 'PHONE_NUMBER':
                ...
                if not phone_number:
                    validation_errors[f"button_{i}_phone_number"] = "phone_number is required for PHONE_NUMBER type buttons"
                ...
                if otp_type == 'ONE_TAP':
                    if not button_data.get('package_name'):
                        validation_errors[f"button_{i}_package_name"] = "package_name is required for ONE_TAP OTP buttons"
                    if not button_data.get('signature_hash'):
                        validation_errors[f"button_{i}_signature_hash"] = "signature_hash is required for ONE_TAP OTP buttons"
            ...
            "items": openapi.Schema(
                ...
                properties={
                    "headerType": openapi.Schema(
                        type=openapi.TYPE_STRING,
                        enum=["IMAGE", "VIDEO"],
                        description="Type of card header media"
                    ),
                    ...
                    "sampleText": openapi.Schema(
                        type=openapi.TYPE_STRING,
                        description="Sample text for the card body"
                    ),
            ...
            if card_buttons:
                ...
                for j, button_data in enumerate(card_buttons):
                    ...
                    if button_type not in valid_card_button_types:
                        validation_errors[f"card_{i}_button_{j}_type"] = f"Invalid card button type. Must be one of: {', '.join(valid_card_button_types)}"
                    ...
                    if button_type == 'PHONE_NUMBER':
                        phone_number = button_data.get('phone_number')
                        if not phone_number:
                            validation_errors[f"card_{i}_button_{j}_phone_number"] = "phone_number is required for PHONE_NUMBER type buttons"
