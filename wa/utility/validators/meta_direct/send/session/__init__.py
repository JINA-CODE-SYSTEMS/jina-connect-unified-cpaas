...
from .audio_message_request import (AudioMessageSendRequestValidator,
                                    validate_audio_message_send)
from .contacts_message_request import (ContactsMessageSendRequestValidator,
                                       validate_contacts_message_send)
from .document_message_request import (DocumentMessageSendRequestValidator,
                                       validate_document_message_send)
from .image_message_request import (ImageMessageSendRequestValidator,
...
from .location_message_request import (LocationMessageSendRequestValidator,
                                       validate_location_message_send)
from .reaction_message_request import (ReactionMessageSendRequestValidator,
                                       validate_reaction_message_send)
from .sticker_message_request import (StickerMessageSendRequestValidator,
                                      validate_sticker_message_send)
from .text_message_request import (TextMessageSendRequestValidator,
                                   validate_text_message_send)
from .video_message_request import (VideoMessageSendRequestValidator,
