...
from wa.utility.data_model.gupshup.template_card_input import TemplateCardsInput, parse_template_cards
...
class UtilityTemplateValidator(BaseTemplateValidator):
    """
    Gupshup UTILITY template validator.
    ...
    cards: Optional[TemplateCardsInput] = None  # handle cards for product or catalog based templates
