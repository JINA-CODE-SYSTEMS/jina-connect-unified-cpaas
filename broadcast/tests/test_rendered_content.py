...
class BroadcastRenderedContentTestCase(TestCase):
    ...
    def test_render_content_with_all_placeholders_available(self):
        ...
        self.wa_template.content = (
            "Your booking {{ booking_id }} to {{ destination }} is confirmed!"
        )
    ...
    def test_render_content_with_contact_name_variations(self):
        ...
        self.wa_template.content = (
            "Hello {{ first_name }} {{ last_name }}, welcome to {{ company_name }}!"
        )
        self.wa_template.save()
    ...
    def test_render_content_with_single_name(self):
        ...
        self.wa_template.content = (
            "Hi {{ first_name }} {{ last_name }}, your contact is {{ phone }}!"
        )
        self.wa_template.save()
    ...
    def test_render_content_with_date_time_variables(self, mock_datetime):
        ...
        self.wa_template.content = (
            "Today is {{ today_date }} and current time is {{ current_time }}. "
            "Year: {{ current_year }}"
        )
        self.wa_template.save()
    ...
    def test_render_content_with_broadcast_name(self):
        ...
        self.wa_template.content = (
            "You received this message from {{ broadcast_name }} campaign."
        )
        self.wa_template.save()
    ...
    def test_render_content_placeholder_not_found(self):
        ...
        self.wa_template.content = (
            "Hello {{ first_name }}, your {{ unknown_variable }} is ready!"
        )
        self.wa_template.save()
    ...
    def test_render_content_no_placeholders(self):
        ...
        self.wa_template.content = (
            "This is a simple message with no placeholders."
        )
        self.wa_template.save()
...
def run_broadcast_tests():
    ...
    print(f"\n{'='*60}")
    print(f"BROADCAST RENDERING TEST SUMMARY")
    print(f"{'='*60}")
