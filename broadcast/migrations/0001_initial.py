    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("name", models.CharField(help_text="Broadcast campaign name", max_length=255)),
                ...
                (
                    "platform",
                    models.CharField(
                        choices=[("WHATSAPP", "WhatsApp"), ("TELEGRAM", "Telegram"), ("SMS", "SMS")],
                        default="WHATSAPP",
                        max_length=20,
                    ),
                ),
                ("task_id", models.CharField(blank=True, editable=False, max_length=255, null=True)),
                ("placeholder_data", models.JSONField(blank=True, default=dict)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "delivered_at",
                    models.DateTimeField(blank=True, help_text="Timestamp when message was delivered", null=True),
                ),
