    ...
    def handle(self, *args, **options):
        ...
        with connection.cursor() as cursor:
            ...
            if initial_cost_count > 0:
                ...
                self.stdout.write(
                    self.style.SUCCESS(f"✓ Updated initial_cost_currency for {initial_cost_count} records")
                )
            ...
            if refund_amount_count > 0:
                ...
                self.stdout.write(
                    self.style.SUCCESS(f"✓ Updated refund_amount_currency for {refund_amount_count} records")
                )
