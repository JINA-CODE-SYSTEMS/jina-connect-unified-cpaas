...
class BroadcastViewSet(BaseTenantModelViewSet):
    ...
    def get_queryset(self):
        ...
        queryset = queryset.annotate(
            ...
            success_count=Count('broadcasts', filter=Q(broadcasts__status__in=[
                MessageStatusChoices.SENT, MessageStatusChoices.DELIVERED, MessageStatusChoices.READ
            ])),
